...
public class PostNamesTests(ApiFactory factory) : BaseTest(factory)
{
    ...
    public async Task ShouldGive401_WhenNotAuthenticated()
    {
        ...
        //Act
        var response = await client.PostAsJsonAsync($"/api/v1/users/{randomGuid}/names", ValidUserNamesDto());
    ...
    public async Task OK_When_Authenticated()
    {
        ...
        //Act
        var response = await client.PostAsJsonAsync($"/api/v1/users/{validUser.UserId}/names", ValidUserNamesDto());
    ...
    public async Task BadRequest_When_Invalid_Data()
    {
        ...
        //Act
        var response = await client.PostAsJsonAsync($"/api/v1/users/{validUser.UserId}/names", InvalidUserNamesDto());

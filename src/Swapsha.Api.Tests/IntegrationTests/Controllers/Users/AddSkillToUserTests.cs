...
public class AddSkillToUserTests(ApiFactory factory) : BaseTest(factory)
{
    ...
    public async Task BadRequest_When_Non_Valid_Id_Route()
    {
        ...
        var response = await client.PostAsJsonAsync($"api/v1/users/{445484}/skills", 1);
    ...
    public async Task Unauthorized_When_No_Bearer_Header()
    {
        ...
        var response = await client.PostAsJsonAsync($"api/v1/users/{randomGuid}/skills", 1);
    ...
    public async Task BadRequest_When_User_Already_Has_Skill()
    {
        ...
        var response = await client.PostAsJsonAsync($"api/v1/users/{validUser.UserId}/skills", user.Skills[0]);
    ...
    public async Task NotFound_When_SkillId_Is_Not_A_Valid_Skill()
    {
        ...
        var response = await client.PostAsJsonAsync($"api/v1/users/{validUser.UserId}/skills", 54898);
    ...
    public async Task OK_When_Successfully_Added_Skill()
    {
        ...
        var response = await client.PostAsJsonAsync($"api/v1/users/{validUser.UserId}/skills", newSkill.Id);

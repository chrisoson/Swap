    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserWantedSkills", x => new { x.UserId, x.SkillId });
                    table.ForeignKey(
                        name: "FK_UserWantedSkills_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserWantedSkills_Skills_SkillId",
                        column: x => x.SkillId,
                        principalTable: "Skills",
                        principalColumn: "SkillId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Kunskaper inom programmering", "Programmering" },
                    { 2, "Kunskaper inom svenska", "Svenska" },
                    { 3, "Kunskaper inom engelska", "Engelska" },
                    { 4, "Kunskaper inom matematik", "Matematik" }
                });

            migrationBuilder.InsertData(
                table: "SubSkills",
                columns: new[] { "Id", "Description", "Name", "SkillId" },
                values: new object[,]
                {
                    { 1, "Kunskaper inom C#", "C#", 1 },
                    { 2, "Kunskaper inom Java", "Java", 1 },
                    { 3, "Kunskaper inom Python", "Python", 1 },
                    { 4, "Kunskaper inom grammatik", "Grammatik", 2 },
                    { 5, "Kunskaper inom ordförråd", "Ordförråd", 2 },
                    { 6, "Kunskaper inom stavning", "Stavning", 2 },
                    { 7, "Kunskaper inom amerikansk engelska", "Amerikansk engelska", 3 },
                    { 8, "Kunskaper inom brittisk engelska", "Brittisk engelska", 3 },
                    { 9, "Kunskaper inom matematik 1", "Matematik 1", 4 },
                    { 10, "Kunskaper inom matematik 2", "Matematik 2", 4 },
                    { 11, "Kunskaper inom matematik 3", "Matematik 3", 4 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserWantedSkills_SkillId",
